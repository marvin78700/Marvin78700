...
**Systèmes**
- Linux (Debian, Raspberry Pi OS) — administration, scripting bash
- Windows Server 2019 et 2022 — configuration, rôles, partages

**Réseaux**
- VLAN, routage, DHCP, DNS
- VPN WireGuard
- Pi-hole + Unbound (DNS récursif local)
...
**Virtualisation**
- Proxmox (Notions et bases), VMware, Hyper-V (Notions et Bases)
...
- **Pi-hole** — filtrage DNS et blocage des publicités
- **Unbound** — résolveur DNS récursif local (zéro dépendance externe)
...
- DHCP par VLAN, VoIP, Call Manager
- Simulé sur Proxmox/VMware

### 🖥️ Windows Server 2022
- Configuration standalone — rôles AD DS, DNS, DHCP
- Gestion des utilisateurs, GPO, partages réseau
